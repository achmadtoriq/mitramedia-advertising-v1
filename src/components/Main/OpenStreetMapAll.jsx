...
export default function OpenStreetMapAll({markers}) {
  ...
  return (
    <>
    <MapContainer center={centerLoc} className='rounded-lg z-0' style={{ width: '87vw', height: '80vh' }}>
      <TileLayer
        ...
        >
          <Popup closeOnClick>
            <div className="text-center">
              ...
              <button type='button' onClick={() => openModal(position)} className="rounded-full bg-black py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">show image</button>
            </div>
          </Popup>
        </Marker>
      )})}
        ...
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full transform rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all lg:w-1/2">
                  <Dialog.Title
                    as="h3"
